...
const TransRow: NextPage<RowProps> = ({
  value,
  trans,
  setTrans,
  unpaid,
  ...
  return (
    ...
    >
      <span className="rounded-l py-4 pl-2 text-left transition group-hover:group-hover:bg-red-200">
        {value.purchase.item.displayName}
      </span>
      <span className="py-4 text-end transition group-hover:group-hover:bg-red-200">
        {value.amount}
      </span>
      <span className="rounded-r py-4 pr-2 text-end transition group-hover:group-hover:bg-red-200">
